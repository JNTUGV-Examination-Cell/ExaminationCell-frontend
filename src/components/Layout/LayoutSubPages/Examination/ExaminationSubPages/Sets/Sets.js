...
//             style={{
//               height: 30,
//               // backgroundColor: activeSetting === 'Sets Allocation' ? 'lightblue' : 'transparent',
//               // color: activeSetting === 'Sets Allocation' ? 'darkblue' : 'black',
//             }}
...
//             style={{
//               height: 30,
//               // backgroundColor: activeSetting === 'Mark Absent' ? 'lightblue' : 'transparent',
//               // color: activeSetting === 'Mark Absent' ? 'darkblue' : 'black',
//             }}
...
//             style={{
//               height: 30,
//               // backgroundColor: activeSetting === 'Mark MalPractice' ? 'lightblue' : 'transparent',
//               // color: activeSetting === 'Mark MalPractice' ? 'darkblue' : 'black',
//             }}
...
//             style={{
//               height: 30,
//               // backgroundColor: activeSetting === 'Download D Form' ? 'lightblue' : 'transparent',
//               // color: activeSetting === 'Download D Form' ? 'darkblue' : 'black',
//             }}
...
//           <Paper elevation={3} className='set-box' style={{ backgroundColor: '#b8e7ee', display: "flex","flexDirection":" column",
//     "alignItems": "center" }}>
...
//         </Grid>
//         <Grid item xs={6} className='set2'>
//           <Paper elevation={3} className='set-box' style={{ backgroundColor: '#b8e7ee', display: "flex","flexDirection":" column",
//     "alignItems": "center"}}>
//             <Typography variant='h6'>SET 2</Typography>
//             <hr style={{ width: '60%' }} />
//             <Typography variant='h6' style={{ color: 'red' }}>Not Available</Typography>
//             <hr style={{ width: '60%' }} />
//           </Paper>
...
// <Grid item xs={6} className='set3'>
//           <Paper elevation={3} className='set-box' style={{ backgroundColor: '#b8e7ee', display: "flex","flexDirection":" column",
//     "alignItems": "center",marginTop: "120px"}}>
//             <Typography variant='h6'>SET 3</Typography>
//             <hr style={{ width: '60%' }} />
//             <Typography variant='h6' style={{ color: 'red' }}>Not Available</Typography>
//             <hr style={{ width: '60%' }} />
//           </Paper>
...
//         <Grid item xs={6} className='set4'>
//           <Paper elevation={3} className='set-box' style={{ backgroundColor: '#b8e7ee',display: "flex","flexDirection":" column",
//     "alignItems": "center",marginTop: "120px"}}>
//             <Typography variant='h6'>SET 4</Typography>
//             <hr style={{ width: '60%' }} />
//             <Typography variant='h6' style={{ color: 'red' }}>Not Available</Typography>
//             <hr style={{ width: '60%' }} />
//           </Paper>
