...
//         <div>
//           <h3>
//             {selectedCourse} {selectedRegulation} {selectedYear}{" "}
//             {selectedBranch} Exam Notifications
//           </h3>
...
//             </AccordionSummary>
//             <AccordionDetails>
//               {/* Content for supply students */}
//               <Typography>Supply subjects content goes here.</Typography>
//             </AccordionDetails>
//           </Accordion>
//         </div>
//       )}
    ...
    const fetchExamNotifications = async () => {
      try {
        const response = await fetch(
          "http://localhost:9000/api/exam_notification/fetchAll"
        );
        if (response.ok) {
          const data = await response.json();
          setExamNotifications(data);
        } else {
          console.error("Error fetching exam notifications:", response.status);
        }
      } catch (error) {
